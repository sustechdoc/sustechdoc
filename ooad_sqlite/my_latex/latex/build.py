...
class LatexMkBuilder(LatexBuilder):
    ...
    # @data('source')
    def build_pdf(self, cur_dir, file_name,  texinputs=[]):
        #with TempDir() as tmpdir,\
            ...
            # tmp.close()
            #diro =
        with open(cur_dir+file_name) as latex_file:
            latex_file.close()
            base_fn = os.path.splitext(latex_file.name)[0]
